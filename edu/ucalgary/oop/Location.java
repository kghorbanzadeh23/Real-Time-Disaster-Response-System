...
public class Location {
    ...
    // Add a method to update name and address and log the update
    public void updateLog(String newName, String newAddress) {
        // Log the old and new names and addresses
        System.out.println("Updating location log:");
        System.out.println("Old Name: " + this.name + ", New Name: " + newName);
        System.out.println("Old Address: " + this.address + ", New Address: " + newAddress);
